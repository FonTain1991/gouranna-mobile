...
export type MutationKeySpecifier = ('createFolder' | 'createIngredient' | 'createPost' | 'createPostCategory' | 'createRecipe' | 'createRecipeCategory' | 'createTranslation' | 'deleteTranslation' | 'recoveryPassword' | 'registration' | 'removeFile' | 'setNewPassword' | 'signIn' | 'signInByGoogle' | 'signOut' | 'updateIngredient' | 'updatePost' | 'updatePostCategory' | 'updatePostCountSee' | 'updateRecipe' | 'updateRecipeCategory' | 'updateRecipeCountSee' | 'updateTranslation' | 'updateUser' | MutationKeySpecifier)[];
export type MutationFieldPolicy = {
	...
	createTranslation?: FieldPolicy<any> | FieldReadFunction<any>,
	deleteTranslation?: FieldPolicy<any> | FieldReadFunction<any>,
	...
	signInByGoogle?: FieldPolicy<any> | FieldReadFunction<any>,
	...
	updateTranslation?: FieldPolicy<any> | FieldReadFunction<any>,
...
export type QueryFieldPolicy = {
	...
	getTranslationById?: FieldPolicy<any> | FieldReadFunction<any>,
	getTranslations?: FieldPolicy<any> | FieldReadFunction<any>,
...
export type TranslationKeySpecifier = ('id' | 'machineName' | 'value' | TranslationKeySpecifier)[];
export type TranslationFieldPolicy = {
	id?: FieldPolicy<any> | FieldReadFunction<any>,
	machineName?: FieldPolicy<any> | FieldReadFunction<any>,
	value?: FieldPolicy<any> | FieldReadFunction<any>
};
export type UserKeySpecifier = ('appleId' | 'avatar' | 'email' | 'facebookId' | 'firstName' | 'googleId' | 'id' | 'lastName' | 'login' | 'now' | 'password' | UserKeySpecifier)[];
export type UserFieldPolicy = {
	appleId?: FieldPolicy<any> | FieldReadFunction<any>,
...
export type StrictTypedTypePolicies = {
	...
	Translation?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | TranslationKeySpecifier | (() => undefined | TranslationKeySpecifier),
		fields?: TranslationFieldPolicy,
	},
